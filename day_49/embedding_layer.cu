...
class CudaEmbeddingImpl : public torch::nn::Module {
    public:
        CudaEmbeddingImpl(int64_t vocab_size, int64_t embedding_dim) {
            // Register the weight parameter properly with requires_grad=true
        ...
        torch::Tensor forward(const torch::Tensor& indices) {
            ...
            return EmbeddingFunction::apply(indices, weight);
        }
        ...
        // Declare weight as a public member variable
        torch::Tensor weight;
    };
